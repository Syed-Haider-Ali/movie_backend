...
app.post('/movie',protectAdmin,upload,async (req,res)=>{
    ...
    app.get('/movie/video/:title', asyncHandler (async(req,res)=>{
    ...
    app.get('/movie/encvideo/:name', asyncHandler (async(req,res)=>{
